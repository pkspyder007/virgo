...
friends.join(
  "*"
); /* Joins and return all the element into a string with the provided character */

friends.shift(); /* Removes and returns first element from the array and shifts all the remaining element to a lower index */

friends.unshift(
  "Jake"
); /* Adds Jake to the beginning of the array and shifts other elements to a higher index */
```
